    ...
    public partial class Ets2DataDebug : Form
    {
        ...
        void updateTimer_Tick(object sender, EventArgs e)
        {
            if (Main.Data.Active != null && Main.Data.Active.Application == "eurotrucks2" && !Main.Data.Active.SelectManually)
            {
                ...
                if (Math.Abs(ets2Tel.Time - this.lastTimestamp) < 100)
                {
                    this.timeoutTicker++;
                }
                else
                {
                    this.timeoutTicker = 0;
                }

                StringBuilder inftext = new StringBuilder();
                if (this.timeoutTicker >= 3)
                {
                ...
                inftext.AppendLine(string.Empty);
                ...
                this.label1.Text = inftext.ToString();

                this.lastTimestamp = ets2Tel.Time;
            }
            else
            {
                this.label1.Text = "Euro Truck Simulator 2 not running";
            }
        }
    }
}